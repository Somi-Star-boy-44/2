#!/usr/bin/python2
# coding=utf-8
import os,sys,time,mechanize,litertools,datetime,random,hashlib,re,threading,json,getpass,urllib,cookielib
...
def pilih_pakis():
	...
	if teak =="":
		...
		pilih_pakis()
	p3 = raw_input('\x1b[1;97m\033[1;97m[\033[1;92m+\033[1;97m] Type Any Password No1 --> ')
        p4 = raw_input('\x1b[1;97m\033[1;97m[\033[1;92m+\033[1;97m] Type Any Password No2 --> ')
